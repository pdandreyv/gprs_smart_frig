...
class BeeSms {
	public $user='xxxx';			
	public $pass='xxx';			
	public $hostname='beeline.amega-inform.ru'; 
	public $path='/sendsms/';
	public $proxy_data=false;
	...
	public function to_multipost($inv) {
	...
	public function post_message($mes,$target,$sender=null) {
		if(is_array($target))	$target=implode(',',$target);
		return $this->post_mes($mes,$target,false,$sender);
	}

	public function post_message_phl($mes,$phl_codename,$sender=null) {
		return $this->post_mes($mes,false,$phl_codename,$sender);
	}
	
	public function post_mes($mes,$target,$phl_codename,$sender,$smstype='SENDSMS') {
		$in=array(
			'action' => 'post_sms',
			'message' => $mes,
			'sender' => $sender,
	...
	public function status_inbox($target=false,$unread=false,$date_from=false,$date_to=false) {
	...
	public function status_sms($date_from,$date_to,$smstype,$sms_group_id,$sms_id) {
	...
	public function get_post_request($invars) {
	...
	public function decode_body($info,$str,$eol="\r\n" ) {
		$tmp=$str;
		$add=strlen($eol);
